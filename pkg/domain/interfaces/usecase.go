...
type IncidentCommand struct {
	...
	SeverityID        string          // Selected by LLM
	AssetIDs          []types.AssetID // Selected by LLM
}
...
type SlackMessage interface {
	...
	SendIncidentMessage(ctx context.Context, channelID, messageTS, title, description, categoryID, severityID string, assetIDs []types.AssetID) error
}
...
type Incident interface {
	...
	// UpdateIncidentDetails updates incident title, description, lead, and severity
	UpdateIncidentDetails(ctx context.Context, incidentID types.IncidentID, title, description string, lead types.SlackUserID, severityID string, updatedBy types.SlackUserID) (*model.Incident, error)
